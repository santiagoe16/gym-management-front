...
export const AttendanceCard: React.FC<AttendanceCardProps> = ({ onSuccess, onUserNotFound, onUserNoPlan }) => {
  const {
    documentId,
  ...
  return (
    <div className="bg-white rounded-lg shadow-lg border border-gray-300 p-6">
      ...
      <form onSubmit={handleAttendanceSubmit} className="space-y-4">
        <div>
          <label htmlFor="documentId" className="block mb-2 text-sm font-medium text-gray-900">
        ...
        <button type="submit" disabled={attendanceSubmitLoading} className="w-full btn-primary">
